            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Textarea id="short_description" className="col-span-3" value={newProject.short_description || ''} onChange={(e) => setNewProject({...newProject, short_description: e.target.value})} />
                </div>
              </div>
              <DialogFooter>
        ...
        <Dialog open={!!editingProject} onOpenChange={() => setEditingProject(null)}>
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="edit-short_description" className="text-right">Short Description</Label>
                <Textarea id="edit-short_description" className="col-span-3" value={editingProject.short_description} onChange={(e) => setEditingProject({...editingProject, short_description: e.target.value})} />
              </div>
            </div>
            <DialogFooter>
